        ...
        t.HSCore.components.HSDatatables = {
                    ...
                    var o = e.DataTable(i),
                        ...
                        l = function () {
                            ...
                            n.wrap('<span class="' + i.paginationItemsClasses + '"></span>'),
                                ...
                                o.wrap(
                                    '<span class="' + i.paginationItemsClasses + '"></span>'
                                ),
                                o
                            ...
                            n.hasClass("disabled") &&
                            (n.removeClass("disabled"), n.parent().addClass("disabled")),
                                o
                                    .unwrap(o.parent())
                                    .wrap(
                                        '<li class="paginate_item ' +
                            ...
                            (o.removeClass("disabled"), o.parent().addClass("disabled")),
                                ...
                                s
                                    .find(".paginate_item")
                                    .appendTo("#" + r.context[0].nTable.id + "_pagination"),
                                a.pages <= 1
                                    ? t("#" + i.pagination).hide()
                                    : t("#" + i.pagination).show(),
                            ...
                            i.scrollY &&
                            e
                                .find(t(".dataTables_scrollBody thead tr"))
            ...
            customColumnsSearch: function (e, a, s) {
                ...
                a.columns().every(function () {
                    ...
                    t(".dataTables_scrollFoot").insertAfter(".dataTables_scrollHead"),
                    ...
                    a
                        .on("select", function () {
                            t(e.classMap.counter).text(a.rows(".selected").data().length),
                                a.rows().data().length !== a.rows(".selected").data().length
                                    ? t(e.classMap.checkAll).prop("checked", !1)
                                    : t(e.classMap.checkAll).prop("checked", !0),
        ...
        t.HSCore.components.HSClipboard = {
                ...
                if (t(e).length) {
                    ...
                    return (
                        r.on("success", function () {
                            ...
                            ("tooltip" === o.type
                                ? (s
                                    .attr("data-original-title", o.successText)
                                    .tooltip("show"),
            ...
            setShortcodes: function (e, a) {
                ...
                t(s.contentTarget).is("input, textarea, select")
                    ...
                    : (s.shortcodes[s.contentTarget] = t(s.contentTarget).html());
            },
        };
    })(jQuery),
    (function (t) {
                ...
                if (e.length) {
                    ...
                    (i = t.extend(!0, s, i, n, a)),
                        e.hasClass("js-step-form")
                            ...
                            : t.validator.setDefaults({ignore: ":hidden:not(select)"});
                    var o = e.validate(i);
                    return (
                                    ...
                                    custom: function (t) {
                                        ...
                                        if (
                                            ...
                                            (((a = document.createElement("div")).id =
                                                ...
                                                i.options.tooltips.lineMode
                                                    ? e.parent(".chartjs-custom").append(a)
                                        ...
                                        if (
                                            ...
                                            s.forEach(function (t) {
                                                r += i.options.tooltips.yearStamp
                                                    ? t + ", " + o.getFullYear()
                                                    : t;
                                            }),
                                                (r +=
                                                ...
                                                n.forEach(function (e, a) {
                                                    ...
                                                    var s = e[0],
                                                        n = s,
                                                        o =
                                                            t.labelColors[a].backgroundColor instanceof
                                                            Object
                                                                ? t.labelColors[a].borderColor
                                                                : t.labelColors[a].backgroundColor;
                                                    (r +=
                                                ...
                                                (r += "</div>"),
                                                (a.querySelector(".hs-chartjs-tooltip").innerHTML =
                                                    r);
                                        }
                                        var l = this._chart.canvas.getBoundingClientRect();
                                        (a.style.opacity = 1),
                                            i.options.tooltips.lineMode
                                                ? (a.style.left = t.caretX + "px")
                                                : (a.style.left =
                                                    l.left +
                                                    window.pageXOffset +
                                                    t.caretX -
                        ...
                        (o.draw = function (e) {
                            if (
                                ...
                                var a = t(this.chart.canvas),
                                    ...
                                    o =
                                        i.options.tooltips.lineWithLineTopOffset >= 0
                                            ? i.options.tooltips.lineWithLineTopOffset
                                            : 7,
                                    l =
                                        i.options.tooltips.lineWithLineBottomOffset >= 0
                                            ? i.options.tooltips.lineWithLineBottomOffset
                                            : 43;
                                t("#chartjsTooltip #chartjsTooltipLine").length ||
                                t("#chartjsTooltip").append(
                                    ...
                                    a.offset().left + a.width() - 100
                                        ? t(".hs-chartjs-tooltip")
                                            .removeClass("hs-chartjs-tooltip-right")
                                            .addClass("hs-chartjs-tooltip-left")
                                        : t(".hs-chartjs-tooltip")
                                            .addClass("hs-chartjs-tooltip-right")
                                            .removeClass("hs-chartjs-tooltip-left"),
                                n.length &&
                                n.css({
                                    position: "absolute",
                                    width: "2px",
                            ...
                            e.on("mousemove", function (a) {
                                ...
                                t(".hs-chartjs-tooltip-wrap").height() / 2 &&
                                a.pageY -
                                e.offset().top +
                                t(".hs-chartjs-tooltip-wrap").outerHeight() / 2 <
                                e.height() &&
                    ...
                    var s = t(e),
                        ...
                        o = {
                            beforeShow: function (e) {
                                var a = t(e.$refs.bg[0]),
                                    s = t(e.current.$slide),
                                    n = e.current.opts.$orig[0].dataset.hsFancyboxOptions
                                        ? JSON.parse(
                                            e.current.opts.$orig[0].dataset.hsFancyboxOptions
                                        )
                                        : {},
                            ...
                            beforeClose: function (e) {
                                var a = t(e.current.$slide),
                                    s = e.current.opts.$orig[0].dataset.hsFancyboxOptions
                                        ? JSON.parse(
                                            e.current.opts.$orig[0].dataset.hsFancyboxOptions
                                        )
                                        : {},
        ...
        t.HSCore.components.HSList = {
                    ...
                    return (
                        r.searchMenu && t(l.list).fadeOut(0),
                            l.on("searchComplete", function () {
                                r.searchMenu &&
                                (s.searchMenu(n, r, l), s.searchMenuHide(n, r, l)),
            ...
            initializeHover: function (e, a, s) {
                ...
                t(o).keydown(function (e) {
                    if (40 === e.which) {
                        if ((e.preventDefault(), 0 == t(i.list).children(".active").length))
                            ...
                            t(n).removeClass("active"),
                                (n = a),
                            t(i.list).height() <
                            t(i.list).children(".active").position().top &&
                            t(i.list).scrollTop(
                                t(i.list).children(".active").position().top +
                                t(i.list).scrollTop()
                            );
                        ...
                        if ((e.preventDefault(), 0 == t(i.list).children(".active").length))
                            ...
                            t(n).removeClass("active"),
                                (n = a),
                            0 > t(i.list).children(".active").position().top &&
                            t(i.list).scrollTop(
                                t(i.list).children(".active").position().top +
                                t(i.list).scrollTop()
                            );
            ...
            searchMenu: function (e, a, s) {
                ...
                if (
                    ...
                    (t(i.list).fadeIn(n.searchMenuDelay), !i.visibleItems.length)
                ) {
                ...
                if (e.length) {
                    var n = Object.assign({}, this.defaults),
                        i = e.attr("data-hs-daterangepicker-options")
                            ? JSON.parse(e.attr("data-hs-daterangepicker-options"))
                            : {},
                        o = {};
                ...
                if (e.length && void 0 !== e.attr("data-hs-ion-range-slider-options")) {
                    var s = Object.assign({}, this.defaults),
                        n = e.attr("data-hs-ion-range-slider-options")
                            ? JSON.parse(e.attr("data-hs-ion-range-slider-options"))
                            : {},
                        i = {
                            onStart: function (e) {
                                ...
                                if (
                                    (i.result_min_target_el && "single" === i.type
                                        ...
                                        : (i.result_min_target_el ||
                                            (i.result_max_target_el && "double" === i.type)) &&
                                        (t(i.result_min_target_el).is("input")
                                            ? t(i.result_min_target_el).val(e.from)
                                            : t(i.result_min_target_el).text(e.from),
                                            t(i.result_min_target_el).is("input")
                                                ? t(i.result_max_target_el).val(e.to)
                                                : t(i.result_max_target_el).text(e.to)),
                                    i.grid &&
                                    "single" === i.type &&
                                    t(e.slider)
                                        .find(".irs-grid-text")
