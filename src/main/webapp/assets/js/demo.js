function HSDemo() {
  ...
  var skin = window.localStorage.getItem('hs-builder-skin') === null ? 'navbar-dark' : window.localStorage.getItem('hs-builder-skin'),
      sidebarMode = window.localStorage.getItem('hs-builder-sidebar-mode') === null ? '' : window.localStorage.getItem('hs-builder-sidebar-mode'),
      headerMode = window.localStorage.getItem('hs-builder-header-mode') === null ? 'single-container' : window.localStorage.getItem('hs-builder-header-mode');
