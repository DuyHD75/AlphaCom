                    ...
                    <div class="text-center">
                        <div class="custom-checkbox-card mb-2">
                            ...
                            <label class="custom-checkbox-card-label" for="headerLayoutOptions4">
                                <img class="custom-checkbox-card-img"
                                     src="assets\svg\layouts\header-double-line-container.svg" alt="Image Description">
                            </label>
    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center mb-3">
                <div class="col-sm">
                    <h1 class="page-header-title">Orders <span class="badge badge-soft-dark ml-2">${countOrder}</span>
                    </h1>
                    ...
                    <div class="col-lg-6">
                      ...
                      <span class="font-size-sm mr-3">
                        ...
                        Selected
                                    ...
                                    <a class="btn btn-sm btn-outline-danger" id="deleteButton" href="#"
                        ...
                        <c:forEach items="${orders}" var="ord">
                            <tr>
                                <td class="table-column-pr-0">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" name="orderId" value="${ord.id}"
                                               class="custom-control-input" id="ordersCheck${ord.id}">
                                ...
                                <td>
                                    <a class="text-body"
                                       href="adminCustomer?action=viewCustomerDetail&&Cid=${ord.getCustomer().getId()}">${ord.getCustomer().getName()}</a>
                                </td>
                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                        <a class="btn btn-sm btn-white"
                                           href="adminOrder?action=viewOrderDetail&&Oid=${ord.id}&&Cid=${ord.getCustomer().getId()}">
                                        ...
                                        <div class="hs-unfold btn-group">
                                         ...
                                         "smartPositionOffEl": "#datatable"
                                            ...
                                            <div id="ordersExportDropdown${ord.id}"
                                                ...
                                                <a class="js-export-copy dropdown-item" href="javascript:;">
                                                    <img class="avatar avatar-xss avatar-4by3 mr-2"
                                                         src="svg\illustrations\copy.svg" alt="Image Description">
                                                    Copy
                                                </a>
                                                <a class="js-export-print dropdown-item" href="javascript:;">
                                                    <img class="avatar avatar-xss avatar-4by3 mr-2"
                                                         src="svg\illustrations\print.svg" alt="Image Description">
                                                    Print
                                                </a>
                                                <div class="dropdown-divider"></div>
                                                <span class="dropdown-header">Download options</span>
                                                <a class="js-export-excel dropdown-item" href="javascript:;">
                                                    <img class="avatar avatar-xss avatar-4by3 mr-2"
                                                         src="svg\brands\excel.svg" alt="Image Description">
                                                    Excel
                                                </a>
                                                <a class="js-export-csv dropdown-item" href="javascript:;">
                                                    <img class="avatar avatar-xss avatar-4by3 mr-2"
                                                         src="svg\components\placeholder-csv-format.svg"
                                                         alt="Image Description">
                                                    .CSV
                                                </a>
                                                <a class="js-export-pdf dropdown-item" href="javascript:;">
                                                    <img class="avatar avatar-xss avatar-4by3 mr-2"
                                                         src="svg\brands\pdf.svg" alt="Image Description">
                                                    PDF
                                                </a>
                                                <div class="dropdown-divider"></div>
                                                <a class="dropdown-item"
                                                   href="adminOrder?action=deleteOrder&&Oid=${ord.id}"
                                                   onclick="return confirm('Are you sure delete order?');">
