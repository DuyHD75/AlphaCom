    ...
    <div class="content container-fluid">
        ...
        <div class="row gx-2 gx-lg-3">
            ...
            <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
                ...
                <a class="card card-hover-shadow h-100" href="#">
                    <div class="card-body">
                        <h6 class="card-subtitle">Total Shipping</h6>
            ...
            <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
                ...
                <a class="card card-hover-shadow h-100" href="#">
                    <div class="card-body">
                        <h6 class="card-subtitle">Total Completed</h6>

                        <div class="row align-items-center gx-2 mb-1">
                            <div class="col-6">
                                <span class="card-title h2">${completed}</span>
                            </div>
                    ...
                    <c:forEach var="customer" items="${customers}">
                        ...
                        <tr>
                            <td class="table-column-pr-0">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="${customer.getId()}">
                                    <label class="custom-control-label" for="${customer.getId()}"></label>
                                </div>
                            </td>
