            ...
            <div class="col-lg-9">
                ...
                <div class="card mb-3 mb-lg-5">
                        ...
                        <div class="profile-cover-img-wrapper">
                            ...
                            <div class="profile-cover-content profile-cover-btn">
                                <div class="custom-file-btn">
                                    <input type="file" class="js-file-attach custom-file-btn-input"
                    ...
                    <label class="avatar avatar-xxl avatar-circle avatar-border-lg avatar-uploader profile-cover-avatar"
                           for="avatarUploader">
                        <img id="avatarImg" class="avatar-img" src="assets\img\160x160\img6.jpg"
                             alt="Image Description">
                  ...
                  <i class="tio-edit avatar-uploader-icon shadow-soft"></i>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-5">
                                <span class="d-block font-size-sm mb-2">Who can see your profile photo? <i
                                        class="tio-help-outlined" data-toggle="tooltip" data-placement="top"
                ...
                <!-- Card -->
                <div class="card mb-3 mb-lg-5 text-success">
                    ...
                    <div class="card-body">
                        <!-- Form -->
                        <c:if test="${sessionScope.acc == null&& sessionScope.accMana==null}">
                                ...
                                <div class="row form-group d-none">
                                    ...
                                    <div class="col-sm-9 d-none">
                                        <div class="select2-custom auto-apply">
                                            <select class="js-select2-custom custom-select" size="1" style="opacity: 0;"
                                                    name="roleSelect" id="editRoleModalLabel" data-hs-select2-options='{
                                      "minimumResultsForSearch": "Infinity",
                                      "dropdownAutoWidth": true,
                                      "width": "6rem"
                                    }'>
                                    ...
                                    <div class="col-sm-9">
                                        <div class="js-form-message input-group input-group-sm-down-break ">
                                            <input type="text" class="form-control"
                                                   name="editNameModal" id="editNameModalLabel"
                                                   placeholder="Your Name" aria-label="Your name"
                                                   value="${sessionScope.accMana.name}">
                                            <span class="form__msg "></span>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-9">
                                        <div class="js-form-message">
                                            ...
                                            <input type="email" class="form-control"
                                                   name="editEmailModal" id="editEmailModalLabel"
                                                   placeholder="Email" aria-label="Email"
                                                   value="${sessionScope.accMana.email}">
                                            <span class="form__msg "></span>
                                        </div>
                                            <%-- ID để nhận dạng cái input--%>
                                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <c:if test="${sessionScope.acc != null}">
                            ...
                            <div class="row form-group">
                                ...
                                <p class="form__msg text-danger ">${messCurrent}</p>
                            </div>
                            <!-- End Form Group -->
                            ...
                            <div class="row form-group">
                                ...
                                <p class="form__msg text-danger"></p>
                            </div>
                            <!-- End Form Group -->

                            <!-- Form Group -->
                            <div class="row form-group">
                                <label for="confirmPassword" class="col-sm-3 col-form-label input-label">Confirm new
                                    password</label>
                        ...
                        <c:if test="${sessionScope.accMana != null}">
                            <form method="post" action="managerProfile" id="form-password">
                                ...
                                <div class="row form-group">
                                    ...
                                    <p class="form__msg invalid">${messCurrent}</p>
                                </div>
                                <!-- End Form Group -->
                ...
                <div id="notificationsSection" class="card mb-3 mb-lg-5 d-none">
                    ...
                    <div class="alert alert-soft-dark card-alert text-center" role="alert">
                        We need permission from your browser to show notifications. <a class="alert-link" href="#">Request
                        permission</a>
                    </div>
                    <!-- End Alert -->
                            ...
                            <table class="table table-thead-bordered table-nowrap table-align-middle card-table">
                                ...
                                <tr>
                                    ...
                                    <th class="text-center">
                                        <div class="mb-1">
                                            <img class="avatar avatar-xs" src="assets\svg\illustrations\at-line.svg"
                                                 alt="Image Description">
                                        </div>
                                        Email
                                    </th>
                                    <th class="text-center">
                                        <div class="mb-1">
                                            <img class="avatar avatar-xs" src="assets\svg\illustrations\world-line.svg"
                                                 alt="Image Description">
                                        </div>
                                        Browser
                                    </th>
                                    <th class="text-center">
                                        <div class="mb-1">
                                            <img class="avatar avatar-xs" src="assets\svg\illustrations\phone-line.svg"
                                                 alt="Image Description">
                                        </div>
                                        App
                                    </th>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id="alertsCheckbox1"
                                                   checked="">
                                ...
                                <tr>
                                    <td>Account activity <i class="tio-help-outlined text-body ml-1"
                                                            data-toggle="tooltip" data-placement="top"
                                                            title="Get important notifications about you or activity you've missed"></i>
                                    </td>
                                    <td class="text-center">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id="alertsCheckbox4"
                                                   checked="">
                                    ...
                                    <td class="text-center">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id="alertsCheckbox5"
                                                   checked="">
                                    ...
                                    <td class="text-center">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id="alertsCheckbox6"
                                                   checked="">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id="alertsCheckbox7"
                                                   checked="">
                                    ...
                                    <td class="text-center">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id="alertsCheckbox8"
                                                   checked="">
                                    ...
                                    <td class="text-center">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id="alertsCheckbox9"
                                                   checked="">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id="alertsCheckbox11"
                                                   checked="">
                                ...
                                <tr>
                                    <td>A new device connected <i class="tio-help-outlined text-body ml-1"
                                                                  data-toggle="tooltip" data-placement="top"
                                    ...
                                    <td class="text-center">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id="alertsCheckbox14"
                                                   checked="">
                                    ...
                                    <td class="text-center">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id="alertsCheckbox15"
                                                   checked="">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">In order to cut back on noise, email notifications are grouped together and
                            only sent when you're idle or offline.</p>
...
<script>
    ...
    Validator({
        ...
        erorrSelector: '.form__msg',
        rules: [
            Validator.isRequired("#currentPasswordLabel",'Please enter your password'),
            Validator.isPassword('#currentPasswordLabel', 8),
        ],
